...
import { addSave, inputStep } from "atoms/main/mainAtom";
...
const Additional = () => {
  ...
  const [add, setAdd] = useRecoilState(addSave);
  /** 이미지 배열 **/
