...
const Footer = () => {
  return (
    <footer className="h-full w-full bg-textColor flex justify-center items-center mt-4">
      <div className="bg-textColor max-w-[1000px] w-full h-28 text-white font-SCDream5 px-1 py-1 flex flex-col justify-between tablet:flex-row tablet:items-center tablet:h-40 desktop:w-3/4 desktop:h-52 desktop:min-w-[1000px]">
