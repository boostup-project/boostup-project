...
import com.codueon.boostUp.domain.chat.dto.req.PostRoom;
...
public class RoomService {
    ...
    public Long getOrCreate(PostRoom postRoom) {
        Member tutor = memberDbService.ifExistsReturnMember(postRoom.getMerchantId());
        Member student = memberDbService.ifExistsReturnMember(postRoom.getStudentId());

        ChatRoom findRoom = chatRepository.getOrCreate(postRoom.getMerchantId(), postRoom.getStudentId())
