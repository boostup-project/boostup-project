...
public class LessonPostTest extends LessonControllerTest{
    ...
    void updateLessonDetail() throws Exception {
        ...
        doNothing().when(lessonService).updateLessonDetail(Mockito.anyLong(), Mockito.anyLong(), Mockito.any(PostLessonDetailEdit.class), Mockito.anyList());
    ...
    void updateLesson() throws Exception {
        ...
        doNothing().when(lessonService).updateLessonInfo(Mockito.any(), Mockito.anyLong(), Mockito.any(PostLessonInfoEdit.class), Mockito.any());
